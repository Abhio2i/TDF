/* ========================================================================= */
/* File: weapon.cpp                                                          */
/* Purpose: Base Weapon implementation — follows sensor.cpp pattern.         */
/*          Shared fields, component management, empty virtual stubs.        */
/*          Subclasses provide all type-specific behaviour.                  */
/* ========================================================================= */
