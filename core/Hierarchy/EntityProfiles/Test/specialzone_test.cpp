...
void test_Specialzone_component_function() {
    std::cout << "\n--- Running Specialzone_component Tests ---" << std::endl;
    Hierarchy* h = new Hierarchy();
    ProfileCategaory* p = new ProfileCategaory(h);
    Specialzone* e = new Specialzone(h);
...
void test_Specialzone_OthersFunction() {
    std::cout << "\n--- Running Specialzone_OthersFunction Tests ---" << std::endl;
    Hierarchy* h = new Hierarchy();
...
void Specialzone_test(){
    testsPassed = 0;
    testsFailed = 0;
    tests = 0;
    std::cout << "=========================================" << std::endl;
    std::cout << "      SPECIALZONE CUSTOM UNIT TESTS        " << std::endl;
    std::cout << "=========================================" << std::endl;

    test_Specialzone_initialization();
    test_Specialzone_component_function();
    test_Specialzone_OthersFunction();
