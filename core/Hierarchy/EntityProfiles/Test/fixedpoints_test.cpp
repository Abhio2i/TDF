...
void test_FixedPoints_component_function() {
    std::cout << "\n--- Running FixedPoints_component Tests ---" << std::endl;
    Hierarchy* h = new Hierarchy();
    ProfileCategaory* p = new ProfileCategaory(h);
    FixedPoints* e = new FixedPoints(h);
...
void test_FixedPoints_OthersFunction() {
    std::cout << "\n--- Running FixedPoints_OthersFunction Tests ---" << std::endl;
    Hierarchy* h = new Hierarchy();
...
void FixedPoints_test(){
    testsPassed = 0;
    testsFailed = 0;
    tests = 0;
    std::cout << "=========================================" << std::endl;
    std::cout << "      FIXEDPOINTS CUSTOM UNIT TESTS        " << std::endl;
    std::cout << "=========================================" << std::endl;

    test_FixedPoints_initialization();
    test_FixedPoints_component_function();
    test_FixedPoints_OthersFunction();
