...
// TEST SUITES
// ==========================================
void test_Collider_initialization() {
    std::cout << "\n--- Running Initialization Tests ---" << std::endl;
    Hierarchy* h = new Hierarchy();
    ProfileCategaory* p = new ProfileCategaory(h);
    Collider* e = new Collider(h);

    ASSERT_NEQ(e,nullptr, "Collider should be return object");
...
void test_Collider_Subcomponent_function() {
    std::cout << "\n--- Running Collider_Subcomponent Tests ---" << std::endl;
    Hierarchy* h = new Hierarchy();
    ProfileCategaory* p = new ProfileCategaory(h);
    Collider* e = new Collider(h);
...
void test_Collider_OthersFunction() {
    std::cout << "\n--- Running Collider_OthersFunction Tests ---" << std::endl;
    Hierarchy* h = new Hierarchy();
...
void Collider_test(){
    ...
    tests = 0;
    std::cout << "=========================================" << std::endl;
    std::cout << "      Collider CUSTOM UNIT TESTS        " << std::endl;
    std::cout << "=========================================" << std::endl;

    test_Collider_initialization();
    test_Collider_Subcomponent_function();
    test_Collider_OthersFunction();
