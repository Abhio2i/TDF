...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Collider_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Collider_t qt_meta_stringdata_Collider = {
    {
QT_MOC_LITERAL(0, 0, 8), // "Collider"
QT_MOC_LITERAL(1, 9, 6), // "Update"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 9) // "deltaTime"

    },
    "Collider\0Update\0\0deltaTime"
};
...
void Collider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Collider *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Collider::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Collider.data,
    qt_meta_data_Collider,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Collider::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Collider.stringdata0))
