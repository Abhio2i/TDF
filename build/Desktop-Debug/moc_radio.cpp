...
QT_MOC_LITERAL(1, 6, 27), // "availableConnectionsUpdated"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 9) // "connArray"

    },
    "Radio\0availableConnectionsUpdated\0\0"
    "connArray"
};
...
void Radio::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Radio::*)(const QJsonArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Radio::availableConnectionsUpdated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Radio::availableConnectionsUpdated(const QJsonArray & _t1)
{
