...
QT_MOC_LITERAL(3, 28, 8) // "viewName"

    },
    "SidebarWidget\0viewSelected\0\0viewName"
};
...
void SidebarWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->viewSelected((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SidebarWidget::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SidebarWidget::viewSelected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SidebarWidget::viewSelected(const QString & _t1)
{
