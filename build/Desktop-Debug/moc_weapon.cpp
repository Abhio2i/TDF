...
QT_MOC_LITERAL(1, 7, 16), // "missileDetonated"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 8), // "weaponID"
QT_MOC_LITERAL(4, 34, 3), // "lat"
QT_MOC_LITERAL(5, 38, 3), // "lon"
QT_MOC_LITERAL(6, 42, 3) // "alt"

    },
    "Weapon\0missileDetonated\0\0weaponID\0lat\0"
    "lon\0alt"
};
...
void Weapon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->missileDetonated((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3])),(*reinterpret_cast< double(*)>(_a[4]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Weapon::*)(const QString & , double , double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Weapon::missileDetonated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Weapon::missileDetonated(const QString & _t1, double _t2, double _t3, double _t4)
{
