...
QT_MOC_LITERAL(1, 8, 17), // "feedbackTriggered"
...
void MenuBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuBar::feedbackTriggered)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MenuBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuBar::newFileTriggered)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MenuBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuBar::recentProjectTriggered)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void MenuBar::feedbackTriggered()
{
...
// SIGNAL 2
void MenuBar::recentProjectTriggered()
{
