#ifndef RADIODISPLAY_TEST_H
#define RADIODISPLAY_TEST_H

#include <QObject>

class RADIODisplay;

class TestRADIODisplay : public QObject
{
    Q_OBJECT
...
private slots:
    ...
    void testUpdateRadarWithEntityButNoRadio();
