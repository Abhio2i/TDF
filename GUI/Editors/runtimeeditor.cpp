...
//         });
        ...
        // connect(runtimeToolBar, &RuntimeToolBar::nextStepTriggered, this, [=]() {
        //     simulation->nextStep();
        //     qDebug() << "Simulation next step.";
        // });
...
//     // Create initial splits - similar to ScenarioEditor layout
...
//         // Similar distribution as ScenarioEditor
    ...
    : QMainWindow(parent)
{
    ...
    // connect(loggerDialog, &LoggerDialog::recordingStart,this, [=]() {
    //     recordingStartTime = QDateTime::currentDateTime();
    ...
    // connect(loggerDialog, &LoggerDialog::recordingPause, this, [=]() {
    //     //loggerDialog->recordingPauseTime = QDateTime::currentDateTime();

    //     runtime->recorder->getRecording()->pause();
    //     loggerDialog->updateRecordingDuration(loggerDialog->pausedTimeMs);
    //     if (recordingTimer) {
    //         recordingTimer->stop();
    //     }

    //     loggerDialog->pausedTimeMs += recordingStartTime.msecsTo(QDateTime::currentDateTime());
    //     //recordingStartTime = QDateTime();
    //     loggerDialog->updateRecordingDuration(loggerDialog->pausedTimeMs);
    //     //loggerDialog->updateRecordingDuration(0);
    // });

    // connect(loggerDialog, &LoggerDialog::recordingResume, this, [=]() {
    //     runtime->recorder->getRecording()->resume();
    //     recordingStartTime = QDateTime::currentDateTime();
    //     if (recordingTimer)
    //         recordingTimer->start(100);
    //     //recordingTimer->start(100);
    // });
    // connect(loggerDialog, &LoggerDialog::recordingStop, this, [=](){
    //     //Stop engine
    //     runtime->recorder->getRecording()->stop();
