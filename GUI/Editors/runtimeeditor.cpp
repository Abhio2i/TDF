...
//     // IFFDisplay connections - FIXED VERSION
...
//             // ✅ USE hierarchy DIRECTLY INSTEAD OF GlobalRegistry
...
//                         //qDebug() << "📡 Scanning with Radio:" << QString::fromStdString(platform->Name)
//                                  //<< "Radio:" << QString::fromStdString(radio->Name);
//                         radio->updateAvailableConnections(platform->transform);
//                         totalScans++;
//                     }
//                 }
//             }
//             //qDebug() << "✅ Total radio scans this cycle:" << totalScans;
//         }
//     });
...
//                 //         iffDisplayUI->selectEntity(entityIt->second);
//                 //         qDebug() << "🎯 Entity selected in IFFDisplay:" << QString::fromStdString(entityIt->second->Name);
//                 //     }
//                 // }
//                 if (iffDisplayUI) {
