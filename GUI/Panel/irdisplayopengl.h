#ifndef IRDISPLAYOPENGL_H
#define IRDISPLAYOPENGL_H
...
class IRDisplayOpenGL : public QWidget
{
    Q_OBJECT
public:
    explicit IRDisplayOpenGL(QWidget *parent = nullptr);
