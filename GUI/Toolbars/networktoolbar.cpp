...
//         bool success = networkManager->startSession(typeCombo->currentText(), portEdit->text().toInt());
//         dialog.accept();
//         showMessage("Session Started", success ? QString("Session started as %1 on port %2")
//                                                      .arg(typeCombo->currentText(), portEdit->text()) : "Failed to start session: Port in use", !success);
//         if (success) {
