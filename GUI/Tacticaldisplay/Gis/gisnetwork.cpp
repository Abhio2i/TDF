...
// GISNetwork
// Purpose:
// - Handles network communication for GIS features
// - Downloads map tiles and performs place search via HTTP requests
// - Emits results asynchronously using Qt signals
//============================================================================
