...
// /* Purpose: Implements the Tactical Rules panel widget                       */
// /* ========================================================================= */

// #include "tacticalrules.h"
// #include "tactical-styles.h"       // All CSS lives here
...
//     grid->setColumnStretch(1, 1);  // value — stretch
//     grid->setColumnStretch(2, 0);  // unit  — fixed
...
//     // %%% Signal Connections %%%
//     connect(applyChangesBtn, &QPushButton::clicked,
//             this, &TacticalRules::onApplyChanges);
//     connect(resetRulesBtn,   &QPushButton::clicked,
//             this, &TacticalRules::onResetRules);
...
// // %%% Style Application %%%
// /* Loads all CSS from tactical-styles.h */
